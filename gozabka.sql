...
--
-- Host: 127.0.0.1
-- Czas generowania: 11 Lis 2019, 01:38
...
INSERT INTO `users` (`id`, `name`, `password`, `email`, `authorized`, `authorizationCode`, `type`) VALUES
(1, 'first', 'first', 'first', 1, 'first', 'first'),
(2, 'second', 'second', 'second', 0, 'second', 'second'),
(3, 'third', 'third', 'third', 1, 'third', 'third');
